...
namespace PetaPoco
{
	...
	public class Database : IDisposable
	{
		...
		public IDbCommand CreateCommand(IDbConnection connection, string sql, params object[] args)
		{
			...
			{
				var Sys_args = new List<object>();
				sql = ProcessParams(sql, args, Sys_args);
				args = Sys_args.ToArray();
			}
        ...
        public void DataSetBuildPageQueries(long skip, long take, string sql, ref object[] args, out string sqlCount, out string sqlPage)
        {
