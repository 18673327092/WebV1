...
namespace Web.Areas.JDYD.Controllers
{
    ...
    /// 部门控制器类
    /// </summary>
    public class DpMentController : AdminBaseController
    {
        public IDpMentService service { get; set; }
        public DpMentController()
        {
            EntityName = "New_DpMent";
        }
        ...
        #region 表单提交
        [HttpPost]
        public JsonResult _Save(New_DpMent entity, AdminCredential User)
        {
            if (entity.ID == 0)
            {
