...
REDIPS.drag = (function () {
	...
	init = function (dd) {
		...
		var self = this,		// assign reference to current object to "self"
			...
			evt,				// event
			obj_Sys_div;		// reference to the DIV element needed for cloned elements 
		...
		if (!document.getElementById('obj_new')) {
			obj_Sys_div = document.createElement('div');
			obj_Sys_div.id = 'obj_new';
			obj_Sys_div.style.width = obj_Sys_div.style.height = '1px';
			div_drag.appendChild(obj_Sys_div);
		}
		// inizialize tables
		init_tables();
	...
	handler_onmousemove = function (e) {
		...
		obj.style.backgroundColor = '#E9EDF1';
		obj.style.border = 'solid #0076A3 1px';
		// set moved_flag
		moved_flag = 1;
