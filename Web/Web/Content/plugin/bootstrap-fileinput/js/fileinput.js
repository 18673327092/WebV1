...
(function (factory) {
    ...
    tPreview = '<div class="file-preview {class}">\n' +
        ...
        '    </div>\n' +
        '</div>';
    tClose = '<div class="file-close fileinput-remove">&times;</div>\n';
    ...
    tModalMain = '<div id="' + MODAL_ID + '" class="file-zoom-dialog file-modal fade" tabindex="-1" aria-labelledby="' +
        MODAL_ID + 'Label"></div>';
    ...
    FileInput.prototype = {
        ...
        _maximizeZoomDialog: function () {
            var self = this, $modal = self.$modal, $head = $modal.find('.modal-header:visible'),
                $foot = $modal.find('.modal-footer:visible'), $body = $modal.find('.file-modal-body'),
        ...
        _setZoomContent: function ($preview, animate) {
            ...
            handler($btnTogh, 'click', function () {
                var $header = $modal.find('.modal-header'), $floatBar = $modal.find('.file-modal-body .floating-buttons'),
